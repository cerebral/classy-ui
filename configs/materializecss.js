  ...
  classnames: {
    ...
    col: {
      variants: ({ columns }) => ({
        ...
        ...Object.keys(columns).reduce((aggr, key) => {
          aggr[key] = `width: ${columns[key]};margin-left: auto;left: auto;right: auto;`;
          aggr[`offset-${key}`] = `margin-left: ${columns[key]};`;
          aggr[`pull-${key}`] = `right: ${columns[key]};`;
          aggr[`push-${key}`] = `position: relative;left: ${columns[key]};`;
